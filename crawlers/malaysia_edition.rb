...
open(url) do |rss|
  ...
  feed.items.each do |item|
    ...
    # else
      ...
      title = item.title
      json_hash = {source:"malaysia_edition",content: content, link: item.link,title: title, month: date.month,day: date.day,year: date.year, pseudo_id: item.link.gsub(/\W/,'_')}
